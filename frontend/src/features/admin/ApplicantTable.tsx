...
import { Mail, Clock, History, Calendar, User } from "lucide-react";
              ...
              return (
                <React.Fragment key={app.id}>
                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-center hidden sm:table-cell align-middle">
                      {hasScores ? (
                        <span className="inline-flex items-center px-2.5 py-1.5 rounded-lg bg-amber-50 text-amber-700 text-[11px] font-bold whitespace-nowrap border border-amber-100">
