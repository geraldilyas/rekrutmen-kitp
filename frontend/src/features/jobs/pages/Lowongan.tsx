        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16 text-center">
          ...
          >
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed">
              Bergabunglah bersama kami untuk menjaga kedaulatan air dan
              membangun infrastruktur berkelanjutan untuk masa depan Indonesia.
            </p>
          </motion.div>
        </section>
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      />
                      <span
                        className={`text-xs font-bold uppercase tracking-wider ${job.kategori === "Konsultan Individu" ? "text-[#FEB700]" : "text-[#0D278D]"}`}
                      >
                        {job.kategori}
                      </span>
                    </div>
