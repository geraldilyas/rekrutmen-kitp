                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mb-4">
                        <span className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 ${
                          item.kategori === 'Konsultan Individu' ? 'bg-[#FEB700]/10 text-[#FEB700]' : 'bg-blue-50 text-[#0D278D]'
                        }`}>
                      ...
                      <div className="flex flex-wrap items-center gap-6">
                        ...
                        <div className="hidden sm:flex items-center gap-4 text-sm text-gray-500 font-medium border-l border-gray-200 pl-6">
                          ...
                          <span className="flex items-center gap-1.5 text-[#0D278D]"><Award size={16} /> {item.lulus.length} Diterima</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-8 md:p-12 border-b border-gray-100 bg-[#fafafa]">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                      <p className="text-gray-500 font-medium">
                        Berdasarkan hasil keputusan panitia, ditetapkan <span className="font-bold text-[#0D278D]">{selectedData?.lulus.length} orang</span> kandidat yang dinyatakan Lulus.
                      </p>
                      ...
                      {selectedData?.lulus.map((person, index) => (
                        ...
                        >
                          <div className="flex items-center gap-5">
                            ...
                            <div>
                              <h5 className="font-bold text-gray-900 text-lg">{person.nama}</h5>
                              <p className="text-sm text-gray-500 font-medium">Nomor Induk: <span className="tracking-widest">{person.nik}</span></p>
                            </div>
                          </div>
