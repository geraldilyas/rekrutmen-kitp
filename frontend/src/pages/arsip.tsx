        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="p-8 flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      <span className={`px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5 ${
                    ...
                    <h3 className="text-xl font-bold text-[#0D278D] mb-2">{job.posisi}</h3>
                  ...
                  <div className="bg-[#fafafa] p-8 md:w-72 border-t md:border-t-0 md:border-l border-gray-100 flex flex-col justify-center items-start md:items-center text-left md:text-center shrink-0">
                    ...
                    <span className="text-xs text-gray-400 font-medium mb-3">Status Akhir:</span>
                    <div className={`w-full px-4 py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 border ${
          ...
          {filteredHistory.length === 0 && (
            <div className="text-center py-24 bg-white rounded-[2rem] border border-gray-100 shadow-sm mt-6">
              ...
              <h3 className="text-xl font-bold text-[#0D278D] mb-2">Riwayat Kosong</h3>
              <p className="text-gray-500 text-sm">Anda belum memiliki riwayat lamaran dengan status ini.</p>
            </div>
          )}
        </section>
      </main>
